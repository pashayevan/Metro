...
metro::metro(const std::string& stationName) : name(stationName) {}

void metro::trainArrives(const std::string& trainID) {
...
void metro::trainDeparts(const std::string& trainID) {
    std::lock_guard<std::mutex> lock(stationMutex);
